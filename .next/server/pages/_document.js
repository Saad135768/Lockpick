...
class Document extends next_document__WEBPACK_IMPORTED_MODULE_2___default.a {
  static async getInitialProps(ctx) {
    ...
    const materialUiSheets = new _material_ui_styles__WEBPACK_IMPORTED_MODULE_4__["ServerStyleSheets"]();
    const originalRenderPage = ctx.renderPage;

    try {
      ctx.renderPage = () => originalRenderPage({
        enhanceApp: App => props => styledComponentSheet.collectStyles(materialUiSheets.collect( /*#__PURE__*/Object(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__["jsx"])(App, _objectSpread({}, props))))
      });
