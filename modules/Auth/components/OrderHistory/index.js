...
import OrderHistoryData from "./components/OrderHistoryData"
              ...
              <div className={classes.root}>
                ...
                <TabPanel value={value} index={0}>
                  <Accordion
                    ...
                    onChange={handleChangeTable("panel1")}
                  >
                    <AccordionSummary
                        ...
                        <Grid container spacing={2}>
                          ...
                          <Grid item lg={12} md={12} sm={12} xs={12}>
                            <h4 className={classes.OrdePlaced}>
                              Placed on Monday, 19 April, 2021
                            </h4>
                          </Grid>
                          <Grid item lg={6} md={6}>
                  ...
                  <Accordion
                    ...
                    onChange={handleChangeTable("panel2")}
                  >
                    <AccordionSummary
