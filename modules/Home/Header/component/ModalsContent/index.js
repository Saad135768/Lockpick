    ...
    <div>
      <Slider {...settings1}>
        ...
        >
          ...
          <img className={`${classes.ImageItem} ImageItem1`} src={"https://image.devteam9260.workers.dev/?width=1000&image=https://m2k-static.s3-eu-west-1.amazonaws.com/lock-pick/key.svg"} alt='key icon'/>
          </div>
          <h3>
            Program New
            <br />& Used Key
        ...
        >
           ...
           <img className={`${classes.ImageItem} ImageItem2`} src={"https://image.devteam9260.workers.dev/?width=1000&image=https://m2k-static.s3-eu-west-1.amazonaws.com/lock-pick/rest.svg"} alt='rest icon'/>
          </div>
          <h3>
            Reset Transmission
            <br />
        ...
        >
          ...
          <img className={`${classes.ImageItem} ImageItem3`}src={"https://image.devteam9260.workers.dev/?width=1000&image=https://m2k-static.s3-eu-west-1.amazonaws.com/lock-pick/clone.svg"} alt='clone icon' />
          </div>
