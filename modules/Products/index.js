...
import FirstProductSlider from '../Products/components/FirstProductSlider'
import SecondProductSlider from '../Products/components/SecondProductSlider'
            ...
            <Grid item lg={11} xs={12}>
              ...
              <div className={classes.textHolder}>
                ...
                <div className={classes.ProductsMainImge}>
                  <img
                    src="https://image.devteam9260.workers.dev/?width=1000&image=https://m2k-static.s3-eu-west-1.amazonaws.com/lock-pick/header.png"
                    style={{
                      filter:
